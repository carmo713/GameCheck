    ...
    <nav class="navbar">
      ...
      <div class="dropdown">
        ...
        <div class="menu">
          ...
          <a href="../controllers/logout.php"> Sair </a> <!-- Link para logout -->
        </div>
      </div>
    </nav>
  </header>
    ...
    <div class="semana">
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                // Card clicável com a URL correta
                echo '<div class="card" onclick="window.location.href=\'http://localhost/GameCheck-master/views/jogo-geral.php?id=' . $id_jogo . '\'" style="cursor: pointer;">';
